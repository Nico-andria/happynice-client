...
function Register() {
  ...
  return (
    <div className="center-container">
      <Form layout="vertical" className="form_user" onFinish={register}>
        ...
        <Row gutter={16}>
          ...
          <Col span={12}>
            <Form.Item label="Numéro téléphone" name="phoneNumber">
              <div className="inputForm">
                <svg
                  height="20"
                  viewBox="0 0 32 32"
          ...
          <Col span={24}>
            <Form.Item label="Confirmation du Mot de passe" name="cpassword">
              <div className="inputForm">
                <svg
                  height="20"
                  viewBox="-64 0 512 512"
          ...
          {!isLoading ? (
            <button className="button-submit">S"enregistrer</button>
          ) : (
